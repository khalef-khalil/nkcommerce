    ...
    <div>
      ...
      {activeTab === 'orders' && (
        <motion.div 
          ...
          className="bg-white rounded-xl shadow-sm p-6"
        >
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Statut des commandes</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <div className="flex items-center mb-2">
                ...
                <span className="ml-auto text-sm font-medium text-gray-700">{orderStats?.pending_orders || 0}</span>
              </div>
              <div className="flex items-center mb-2">
                <div className="w-3 h-3 rounded-full bg-green-500 mr-2"></div>
                <span className="text-sm font-medium text-gray-700">Confirmées</span>
                <span className="ml-auto text-sm font-medium text-gray-700">{orderStats?.confirmed_orders || 0}</span>
              </div>
              <div className="flex items-center mb-2">
                <div className="w-3 h-3 rounded-full bg-gray-300 mr-2"></div>
                <span className="text-sm font-medium text-gray-700">Total</span>
                <span className="ml-auto text-sm font-medium text-gray-700">{orderStats?.total_orders || 0}</span>
              </div>
            </div>
            
            <div className="relative pt-5">
              <div className="flex items-center justify-center">
                <div className="w-32 h-32 rounded-full border-8 border-gray-200 flex items-center justify-center text-xl font-bold text-gray-700">
                  {confirmationRate}%
                </div>
              </div>
              <div className="absolute inset-0">
                <svg className="w-full h-full" viewBox="0 0 36 36">
                  ...
                  <path
                    ...
                    stroke="#10B981"
                    strokeWidth="3"
                    strokeDasharray={`${confirmationRate}, 100`}
                  />
                </svg>
              </div>
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-500">Commandes récentes :</span>
              <span className="font-medium text-gray-700">{orderStats?.recent_orders || 0}</span>
            </div>
          </div>
        </motion.div>
      )}
